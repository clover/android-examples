...
public class AuthTest {
  ...
  public void testA() {
    ...
    bundle.putString("tests", "station2_auth.json");
    ...
    device.wait(Until.hasObject(By.res(device.getCurrentPackageName(), "tip1")), LONG_WAIT);

    UiObject2 noTip = device.findObject(By.res(device.getCurrentPackageName(), "tip1"));
    noTip.click();

    UiObject2 next = device.findObject(By.res(device.getCurrentPackageName(), "tipContinueButton"));
    next.click();
