...
public class PayWithSecurePaymentsActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_pay_secure_payments);
  }
  ...
  private class OrderAsyncTask extends AsyncTask<Void, Void, Order> {
    ...
    protected final void onPostExecute(Order order) {
      ...
      if (!isFinishing()) {
        PayWithSecurePaymentsActivity.this.order = order;
        if (order != null) {
