package com.test.all_examples.barcodes;
...
public class BarcodeReceiverActivity extends Activity implements CompoundButton.OnCheckedChangeListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_barcode_receiver);
