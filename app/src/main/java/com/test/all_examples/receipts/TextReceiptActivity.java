...
public class TextReceiptActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_receipt_text);
    ...
    buttonPrint.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        TextReceiptRegistrationProvider.updateReceiptAddOnText(((EditText) findViewById(R.id.additional_text)).getText().toString());
  ...
  private void registerReceiptRegistration() {
    new AsyncTask<Void, Void, Void>() {
      ...
      protected Void doInBackground(Void... params) {
        connector.register(Uri.parse(TextReceiptRegistrationProvider.CONTENT_URI_TEXT.toString()), new ReceiptRegistrationConnector.ReceiptRegistrationCallback<Void>());
        return null;
      }
    }.execute();
  }
  ...
  private void unregisterReceiptRegistration() {
    new AsyncTask<Void, Void, Void>() {
      ...
      @Override
      protected Void doInBackground(Void... params) {
        connector.unregister(Uri.parse(TextReceiptRegistrationProvider.CONTENT_URI_TEXT.toString()), new ReceiptRegistrationConnector.ReceiptRegistrationCallback<Void>());
        return null;
      }
  ...
  private class MyAsyncTask extends AsyncTask<Void, Void, Order> {
    ...
    protected final Order doInBackground(Void... params) {
      ...
      try {
        ...
        cursor = TextReceiptActivity.this.getContentResolver().query(OrderContract.Summaries.contentUriWithAccount(account), new String[]{OrderContract.Summaries.ID}, null, null, OrderContract.Summaries.LAST_MODIFIED + " DESC LIMIT 1");
    ...
    protected final void onPostExecute(Order order) {
      ...
      pj.print(TextReceiptActivity.this, account);
    }
  }
}